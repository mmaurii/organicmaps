...
{
  {
    ...
    Distance const d = Distance::CreateAltitudeFormatted(5);
    TEST_EQUAL(d.GetUnits(), Distance::Units::Meters, ());
  ...
  }
  {
    ...
    Distance const d = Distance::CreateAltitudeFormatted(8849);
    TEST_EQUAL(d.GetUnits(), Distance::Units::Meters, ());
  ...
  }
  {
    ...
    Distance const d = Distance::CreateAltitudeFormatted(12345);
    TEST_EQUAL(d.GetUnits(), Distance::Units::Meters, ());
  ...
  }
  {
    ...
    Distance const d = Distance::CreateAltitudeFormatted(10000);
    TEST_EQUAL(d.GetUnits(), Distance::Units::Feet, ());
