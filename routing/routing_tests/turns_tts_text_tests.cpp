...
UNIT_TEST(GetTtsStreetTextTest)
{
  ...
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu8), "Háromszáz méter után Forduljon jobbra az 1re", ());
  ...
  TEST_EQUAL(m_getTtsText.GetTurnNotification(notificationHu8a), "Háromszáz méter után Forduljon jobbra a 10re", ());
